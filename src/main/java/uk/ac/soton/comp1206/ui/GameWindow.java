...
public class GameWindow {
    ...
    /**
     * Display the scores from multiplayer
     * @param score The players score
     * @param scoreList list of scores
     */
    public void startScores(int score, ArrayList<Pair<SimpleStringProperty, SimpleIntegerProperty>> scoreList) {loadScene(new ScoresScene(this, score, scoreList));}
